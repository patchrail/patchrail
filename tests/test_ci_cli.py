...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 223)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 223)
        self.assertEqual(payload["passed"], 223)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "database_migration_failure": {"failed": 0, "passed": 4, "total_cases": 4},
                ...
                "cpp_build_failure": {"failed": 0, "passed": 2, "total_cases": 2},
            },
        )
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `223`", markdown_proc.stdout)
