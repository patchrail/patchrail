...
- v0.2.0 release-candidate evidence:
  ...
  135-fixture CI Janitor benchmark, read-only GitHub Actions artifact, pilot
...
- CI benchmark: `uv run --extra dev patchrail ci benchmark examples/ci-triage --format json` -> 135 / 135 fixtures passed.
