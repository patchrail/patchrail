...
- `patchrail ci benchmark` over 132 sanitized synthetic fixtures.
...
- Fixture hygiene: 132 / 132 fixtures passed.
- Benchmark: 132 total, 132 passed, 0 failed.
- Top-1 fixture accuracy: 1.0.
- Class coverage: 12 root-cause families.
